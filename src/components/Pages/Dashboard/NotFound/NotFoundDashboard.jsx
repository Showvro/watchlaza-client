...
const NotFount = () => {
  return (
    <div className="flex items-center flex-col justify-center lg:flex-row py-28 px-6 md:px-24 md:py-20 lg:py-48 gap-16 lg:gap-28 my-3">
      ...
      <div className="w-full lg:w-1/2 border-gray-400">
        ...
        <div className="w-3/12 mx-auto">
          <Link to="/home">
            <button className="my-5 px-2 btn btn-primary rounded-none py-3 transition-all">
              Back home
            </button>
          </Link>
        </div>
